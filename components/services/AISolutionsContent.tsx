...
const computerVisionImage = 'https://images.unsplash.com/photo-1507146426996-ef05306b995a?ixlib=rb-4.0.3&auto=format&fit=crop&w=2340&q=80';
                ...
                <div className="container mx-auto px-6 max-w-8xl">
                    ...
                    >
                        ...
                        <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed mb-8">
                            En **Nubeware.ai**, diseñamos, desarrollamos e implementamos soluciones de IA que se integran perfectamente en su infraestructura existente. Nos especializamos en la creación de modelos de **Machine Learning** y **Deep Learning** para resolver problemas complejos.
                        </p>
                    </motion.div>
                    ...
                    >
                        ...
                        <div>
                            ...
                            <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
                                Predecimos tendencias de mercado, comportamiento del consumidor y fallos de equipos para optimizar su estrategia de negocio. Utilizamos algoritmos avanzados de machine learning para analizar patrones históricos y generar insights accionables.
                            </p>
                        </div>
                    </motion.div>
