// components/services/CloudIntegrationContent.tsx
'use client';
...
// Imágenes locales (en /public/images/cloud)
const cloudMigrationImage = '/images/cloud/cloud-migration.png';
const hybridCloudImage = '/images/cloud/hybrid-cloud.png';
const serverlessImage = '/images/cloud/serverless.png';
const dataStorageImage = '/images/cloud/data-storage.png';
            ...
            <section className="py-12 md:py-24 transition-colors duration-300">
                <div className="container mx-auto px-6 max-w-8xl">
                    ...
                    >
                        ...
                        <div className="text-center">
                            <h3 className="text-2xl font-semibold text-gray-300 mb-4">
                                Migración Estratégica a la Nube
                            </h3>
                    ...
                    >
                        ...
                        <div className="text-center">
                            <h3 className="text-2xl font-semibold text-gray-300 mb-4">
                                Servicios Serverless y Computación sin Servidor
                            </h3>
                            <p className="text-lg text-gray-100 leading-relaxed">
